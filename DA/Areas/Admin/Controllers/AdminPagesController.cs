...
namespace DA.Areas.Admin.Controllers
{
    ...
    public class AdminPagesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PageId,PageName,Contents,Published,Thumb,Title,MateDesc,MetaKey,Alias,CreatedAt,Ordering")] Page page, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
